...
[Ground,GroundCrit,ZPosGround] = GetZPosition(SenVert,MountAngle,GroundPresep,ZPosT);

% figure
plot(handles.axes1,Ground,ZPosT,'r--',GroundCrit,ZPosGround,'g','LineWidth',2')
...
%     h1 = area(handles.axes1,GroundCrit,ZPosGround);
%     h1.FaceColor = [0 0.9 0];
%     alpha(.5)
    hold (handles.axes1,'on')
    h2 = area(handles.axes1,GroundCrit,ZPosGround,max(ZPosGround));
    h2.FaceColor = [0 0.9 0];
    alpha(.5)
end
